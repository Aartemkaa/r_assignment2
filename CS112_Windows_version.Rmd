...
overall_market_growth = round(seq(0, 1.8, length=1000) + rnorm(1000, mean=0, sd=0.15), 2)
price = round(stores + stores*(overall_market_growth) + rnorm(1000, mean=0, sd=40), 2)
plot(price, 
...
for (i in 1:1000) {
    abline (a = incorrect_prediction.sim@coef[i, 1], b = incorrect_prediction.sim@coef[i, 2],
            lwd = .5, col = "gray")
}
...
plot(incorrect_prediction.sim@sigma,
     ylim=c(95, 125))
